...
module.exports = {
	...
	userlogin:{
		...
		userName:'用户名',
        passWord:'密码',
        passWordLength:'密码长度为',
        lettersNumbers:'数字和字母组成',
		verifyCode:'验证码',
		loading:'加载中...',
		refresh:'刷新',
		signIn:'登录',
		...
		slideTip: '移动滑块，以完成拼图验证',
        verifySuccTip: '验证成功',
        serverError:'服务器请求失败,请重试',
        findSuccess:'找回密码成功，即将转入登录',
        tips: '提示',
        passwordNoMatch:'两次密码输入不一致',
        verifiWait:'验证中，请稍等...',
        registerSucc:'注册成功，即将转入登录',
        pleaseEnter:'请输入'
	},
	...zhLocale
}