...
import "common/css/asms-common.css";
...
import agGrid from "./../../common/js/agGrid";
Vue.use(agGrid);

import agGrid2 from "../agGrid/ag-grid-test";
Vue.use(agGrid2);

import { AgGridVue } from "ag-grid-vue";
Vue.component("ag-grid", AgGridVue);
//全局注入，不用导入
import baseAgGrid from "../agGrid/baseAgGrid.vue";
Vue.component("base-ag-grid", baseAgGrid);
//全局注入，不用导入
import localGrid from "../agGrid/localGrid.vue";
Vue.component("local-grid", localGrid);
/**
