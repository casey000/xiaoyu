<template>
    <div>
        <div class="tab-title">决议信息
            <el-button type="primary" @click="toAdd()">新增</el-button>
            <el-button type="primary" @click="toShowClose()">关闭</el-button>
        </div>
        <local-grid :columnDefs="conSugMeasureColumn" :height="200" :rowData="tabData" ref="defectList"></local-grid>
        <el-dialog :title="'决议信息'+(showAlert==='edit'?'编辑':'新增')" :visible.sync="showDialog" width="30%" :before-close="handleClose">
        ...
        <el-dialog title="关闭决议说明" :visible.sync="toClose" width="30%" :before-close="handleClose">
            <el-input type="textarea"></el-input>
            <span slot="footer" class="dialog-footer">
				<el-button type="primary" @click="closeSubmit()">提交</el-button>
				<el-button @click="closeKeep">保存</el-button>
				<el-button @click="toClose = false">取 消</el-button>
			</span>
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                name:'结论与建议',
                apiJson:{
                    getData:apiData.TechnicalNotice.sugQueryList,
                    delRow:apiData.TechnicalNotice.sugDelUrl,
                    add:apiData.TechnicalNotice.sugSureAdd,
                    edit:apiData.TechnicalNotice.sugSureUpdate,
                },
                formInfo: {
                    id:'',
                    techId: '',
