<template>
    <div>
        <div class="tab-title">相关文件：部件或系统故障是否有相关AD、SB、SL、FTD等信息：
            是<el-radio v-model="radio" :disabled="otherParams.method === 'view'" label="Y">&nbsp;</el-radio>
            否<el-radio v-model="radio" :disabled="otherParams.method === 'view'" label="N">&nbsp;</el-radio>
            <el-button v-if="otherParams.method !== 'view'" type="primary" @click="toAdd()" :disabled="radio!=='Y'">增加</el-button>
        </div>
            ...
            <el-form :model="formInfo" :rules="formInfoRule" ref="submitForm" label-width="100px">
                ...
                <el-row>
                    <el-form-item label="文件编号：" prop="fileNo">
                        <el-input name="fileNo" :rows="5" placeholder="请输入内容" v-model="formInfo.fileNo" resize="none">
                        </el-input>
                    </el-form-item>
                </el-row>
                <el-row>
                    <el-form-item label="标题：" prop="title">
                        <el-input name="reason" :rows="5" placeholder="请输入内容" v-model="formInfo.title" resize="none">
                        </el-input>
                    </el-form-item>
                </el-row>
            </el-form>
        ...
        data() {
            ...
            return {
                ...
                apiJson:{
                    ...
                    updateSubmit:apiData.TechnicalNotice.partSureAddOrEdit,
                },
                radio: '',
                options: [{
                    value: 'AD',
                ...
                conDicMeasureColumn: [
                    ...
                    { headerName: '文件编号', field: "fileNo", width: 100, suppressFilter: true },
