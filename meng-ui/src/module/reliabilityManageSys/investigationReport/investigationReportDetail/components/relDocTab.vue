    ...
    export default {
        ...
        data() {
            ...
            return {
                name:'相关文件',
                apiJson:{
                    getData:apiData.investigationReport.docQueryList,
                    delRow:apiData.investigationReport.docDelUrl,
                    add:apiData.investigationReport.docSureAdd,
                    edit:apiData.investigationReport.docSureEdit ,
                },
                radio: '',
                options: [{
                    value: 'AD',
