    ...
    export default {
        ...
        methods: {
            ...
            mainGetData(id) {
                ...
                let url = this.apiData.mainQueryList
            ...
            // 维修方案措施延期编辑确认
            mainRowSubmit() {
                let ids = this.$refs.relMainTab.getSelect().map(item => item.evalNo)
            ...
            deleteMainRow(param) {
                ...
                this.$confirm('确认删除此行', '提示', {
                    ...
                    this.$httpExt().post(this.apiData.mainDelUrl,param.data.id, 'gateway').then(res => {
                        this.mainGetData(this.otherParams.id)
                        this.$message({
                            type: 'success',
                            message: '维修方案措施删除成功!'
