...
},beforePageText:"",afterPageText:"/{pages}",displayMsg:"",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.ajax({type:opts.method,url:opts.url,header:opts.headers,xhrFields:opts.xhrFields,crossDomain:opts.crossDomain,data:_7ff,dataType:"json",success:function(data){
_800(data);
},error:function(){
