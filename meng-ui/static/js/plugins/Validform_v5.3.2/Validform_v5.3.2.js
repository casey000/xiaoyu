...
(function ($, win, undef) {
    ...
    var Validform = function (forms, settings, inited) {
        ...
        forms.each(function () {
            ...
            $this.on("blur", "[_target]", function () {
                var directObj = $($(this).attr('_target'));
                if (directObj.length > 0) {
                    var subpost = arguments[1];
                    console.log(2)
                    directObj.attr("_direct", $(this).attr('_target'));
                    Validform.util.check.call(directObj[0], $this, subpost);
                }
            });
    ...
    Validform.util = {
        ...
        showmsg: function (msg, type, o, triggered) {
            ...
            */
            ...
            if ((type == 3 || type == 4) && o.obj) {
                var checktip = o.obj.siblings(".Validform_checktip");
                if (checktip.length == 0) {
                    checktip = o.obj.parent().siblings(".Validform_checktip");
                }
                checktip.html(msg);
                Validform.util.cssctl(checktip, o.type);
            }
        ...
        check: function (curform, subpost, bool) {
            ...
            */
            ...
            var _this;
            errorobj = _this = $(this);
            var _direct = _this.is(":hidden") ? _this.attr('_direct') : "";
            var directObj = _direct ? $("[_target='" + _direct + "']") : _this;
            ...
            if (!flag.passed) {
                ...
                if (!bool) {
                    ...
                    !settings.tipSweep && directObj.addClass("Validform_error");
                }
                return false;
            }
                ...
                var localconfig = {
                    ...
                    success: function (data) {
                        if ($.trim(data.status) === "y") {
                            ...
                            directObj.removeClass("Validform_error");
                            errorobj = null;
                            ...
                            directObj.addClass("Validform_error");
                        }
