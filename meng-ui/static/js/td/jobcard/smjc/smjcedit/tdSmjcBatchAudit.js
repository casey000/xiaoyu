...
function i18nCallBack() {
    ...
    InitFuncCodeRequest_({
        data: {
            domainCode: "DA_FLEET,TD_JC_STATUS,YESORNO,TD_JC_FROM_TO,TD_JC_MODEL,TD_JC_STATE,TD_JC_EXTEND,TD_JC_SMJC_REVIEWED_BY," +
            "TD_JC_SMJC_PROOF_BY",
        ...
        successCallBack: function (jdata) {
            if (jdata.code == RESULT_CODE.SUCCESS_CODE) {
                ...
                $('#reviewedBy').combobox({
                    panelHeight: '100px',
                    data: jdata.data.TD_JC_SMJC_REVIEWED_BY,
                    valueField: 'VALUE',
                    textField: 'TEXT',
...
function InitDataGrid() {
    ...
    $("#dg1").MyDataGrid({
        ...
        sortable: true,
        singleSelect: true,
        queryParams: {status: "AUDIT", reviewedBy: user.accountId},
        ...
        columns: {
            ...
            alter: {
                ...
                REVIEWED_BY: {
                    formatter: function (value) {
                        return PAGE_DATA['TD_JC_SMJC_REVIEWED_BY'][value];
                    }
                },
                REVIEWED_DATE: {
                    type: 'date'
        ...
        contextMenus: [
            ...
            //     id: "m-turnback",
            //     i18nText: "退回",
            //     auth: "TD_JC_SMJC_AUDIT_TURNBACK",
            //     onclick: function () {
            //         var rowData = getDG('dg1').datagrid('getSelected');
            //         if (!rowData.PKID) {
            //             MsgAlert({content: "请选择数据！", type: 'error'});
