...
function i18nCallBack() {
    ...
    InitFuncCodeRequest_({
        data: {
            ...
            "TD_JC_NRCJC_PROOF_BY,TD_JC_NRCJC_REVIEWED_BY",
...
function InitDataGrid() {
    ...
    $("#dg1").MyDataGrid({
        ...
        sortable: true,
        singleSelect: true,
        queryParams: {status: "RATIFY", writer: user.accountId},
        ...
        contextMenus: [
            ...
            //     id: "m-ratifytrunback",
            //     i18nText: "退回",
            //     auth: "TD_JC_NRCJC_RATIFY_TURNBACK",
            //     onclick: function () {
            //         var rowData = getDG('dg1').datagrid('getSelected');
            //         if (!rowData.PKID) {
            //             MsgAlert({content: "请选择数据！", type: 'error'});
            ...
            // },
            {
                id: "m-previewpdf",
                i18nText: "PDF预览",
                auth: "TD_JC_NRCJC_RATIFY_PDFVIEW",
                onclick: function () {
                    var rowData = getDG('dg1').datagrid('getSelected');
                    if (!rowData.PKID) {
                        MsgAlert({content: "请选择数据！", type: 'error'});
