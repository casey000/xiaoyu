...
function InitDataGrid() {
    ...
    $("#dg1").MyDataGrid({
        ...
        sortable: true,
        singleSelect: true,
        queryParams: {status: "AUDIT", writer: user.accountId},
        ...
        contextMenus: [
            ...
            //     id: "m-turnback",
            //     i18nText: "退回",
            //     auth: "TD_JC_NRCJC_AUDIT_TURNBACK",
            //     onclick: function () {
            //         var rowData = getDG('dg1').datagrid('getSelected');
            //         if (!rowData.PKID) {
            //             MsgAlert({content: "请选择数据！", type: 'error'});
            ...
            // },
            {
                id: "m-previewpdf",
                i18nText: "PDF预览",
                auth: "TD_JC_NRCJC_AUDIT_PDFVIEW",
                onclick: function () {
                    var rowData = getDG('dg1').datagrid('getSelected');
                    if (!rowData.PKID) {
                        MsgAlert({content: "请选择数据！", type: 'error'});
