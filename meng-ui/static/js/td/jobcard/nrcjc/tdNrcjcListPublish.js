...
function i18nCallBack() {
    ...
    InitFuncCodeRequest_({
        data: {
            ...
            "TD_JC_NRCJC_PROOF_BY,TD_JC_NRCJC_REVIEWED_BY,TD_JC_NRCJC_APPROVED_BY",
...
function InitDataGrid() {
    ...
    $("#dg1").MyDataGrid({
        ...
        sortable: true,
        singleSelect: true,
        queryParams: {status: "ISSUE", writer: user.accountId, writer: user.accountId},
        ...
        contextMenus: [
            ...
            //                 url: "/views/td/jobcard/nrcjc/tdNrcjcPublishBack.shtml"
            //             });
            //         }
            //     }
            // },
                ...
                handler: function () {
                    ...
                    if (confirm("是否批量发布？")) {
                        $.each(rowData, function (index, obj) {
                            InitFuncCodeRequest_({
                                data: {FunctionCode: 'TD_JC_ALL_NSJC_PUBLISH', pkid: obj.PKID},
                                successCallBack: function (jdata) {
                                    if (jdata.code == RESULT_CODE.SUCCESS_CODE) {
                                        MsgAlert({content: $.i18n.t('msg_tip:TIP.COMMON.OPT_SUCCESS')});
                                        reload_("dg1");
