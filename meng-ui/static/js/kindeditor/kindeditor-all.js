                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        if (showLocal && showRemote && tabs && tabs.selectedIndex === 1 || !showRemote) {
                            ...
                            var file = uploadbutton.fileBox.get(0).files[0];
                                    ...
                                    filereader.onload = function(e) {
                                        if (!orientation || orientation == 1 || orientation > 8) {
                                            ...
                                            img.onload = function () {
                                                ...
                                                clickFn.call(self, e.target.result, file.name, width + "", height + "", 0, "");
                                            }
                                            return ;
                                        }
                                        // normalize
                                        ...
                                        img.onload = function() {
                                            ...
                                            clickFn.call(self, dataURL, file.name, width+"", height+"", 0, "");
                                        }
                                    };
