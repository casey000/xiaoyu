    ...
    function P(aa, ab, X, Z) {
        ...
        if (ae) {
            ...
            var ad = M.ie && M.win ? "ActiveX" : "PlugIn",
                ac = "MMredirectURL=" + O.location.toString().replace(/&/g, escape("%26")) + "&MMplayerType=" + escape(ad) + "&MMdoctitle=" + escape(j.title);
    ...
    function u(ai, ag, Y) {
        ...
        if (aa) {
            ...
            if (M.ie && M.win) {
                ...
                aa.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + escape(ah) + ">" + escape(af) + "</object>";
                N[N.length] = ai.id;
                X = c(ai.id)
            } else {
                var Z = C(r);
