...
function InitDataGrid(id, eoPkid) {
    ...
    $pd[id].MyDataGrid({
        ...
        validAuth: function (row, items) {
            ...
            //}
            if (!iparam.TEST_UPLOAD || operation == 'view') {
        ...
        onDblClickRow: function (index, field, value) {
            flag = "V";
            if(iparam.nameEN == 'emEoApp13'){//禁限装加查看功能
